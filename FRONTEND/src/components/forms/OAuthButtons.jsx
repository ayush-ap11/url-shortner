  ...
  return (
    <div className="space-y-3">
      ...
      <button
        ...
        className="
          w-full py-3 rounded-xl bg-white/[0.02] backdrop-blur-sm
          border border-stone-800 text-white text-sm font-medium 
          flex items-center justify-center gap-3
          hover:bg-white/5 hover:border-stone-700 hover:scale-[1.01]
          active:scale-[0.99]
